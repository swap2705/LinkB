...
public class Vani extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        lv= (ListView) findViewById(R.id.listVani);
        ...
        lv.setAdapter(new ArrayAdapter<String>(Vani.this,android.R.layout.simple_list_item_1,Subject));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,final int position, long id) {
                ...
                if(not!=null) {
                    Intent i = new Intent(Vani.this, Notices.class);
                    i.putExtra("n", not);
                    startActivity(i);
                }
            }
