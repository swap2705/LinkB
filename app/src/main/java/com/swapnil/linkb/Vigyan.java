...
public class Vigyan extends AppCompatActivity {

    List<String> Subject=new ArrayList<>();
    Firebase ref,mref;
    ListView lv;
    String Dep="Vigyan Mandir",not;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_vigyan);

        lv= (ListView) findViewById(R.id.listVigyan);
        ...
        lv.setAdapter(new ArrayAdapter<String>(Vigyan.this,android.R.layout.simple_list_item_1,Subject));
        ...
        lv.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view,final int position, long id) {
                ...
                if(not!=null) {
                    Intent i = new Intent(Vigyan.this, Notices.class);
                    i.putExtra("n", not);
                    startActivity(i);
                }
            }
